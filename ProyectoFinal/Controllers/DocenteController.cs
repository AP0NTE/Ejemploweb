    ...
    public class DocenteController : ControllerBase
    {
        ...
        public DocenteController(DocenteContext context)
        {
            ...
            if (_context.Docente.Count() == 0)
            {
                ...
                _context.Docente.Add(new Docente {Email="s@gmail.com",Usuario="jdbfbj",Clave="vkjnvf",Salon="9°",Lic="nbnfgn",
                Sexo="feme",Nombre="rnbjk",Apellido="gbnk", Fechan="20/09/1990",Documento="12323423",Telefono="134534",estado="ACTIVO"});
